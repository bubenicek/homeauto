...
int main(void)
{
   ...
   VERIFY_FATAL(modbus_rtu_init(UART_MODBUS, UART_MODBUS_BAUDRATE, UART_MODBUS_SETINGS) == 0);
   VERIFY_FATAL(modbus_rtu_recv(UART_MODBUS, CFG_MODBUS_ADDR, modbus_rtu_recv_cb) == 0);
